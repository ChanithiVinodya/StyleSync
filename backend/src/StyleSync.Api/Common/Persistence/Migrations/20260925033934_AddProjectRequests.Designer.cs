...
namespace StyleSync.Api.Common.Persistence.Migrations
{
    ...
    [Migration("20260925033934_AddProjectRequests")]
    partial class AddProjectRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StyleSync.Api.Modules.ProjectRequests.Models.ProjectRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("StyleSync.Api.Modules.ProjectRequests.Models.ProjectRequest", b =>
                {
                    b.HasOne("StyleSync.Api.Common.Identity.AppUser", "Client")
                        .WithMany()
