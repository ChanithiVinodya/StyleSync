                    ...
                    <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-[#1A1715] border border-[#E7E1D7] dark:border-[#2E2824] rounded-2xl shadow-xl z-50 overflow-hidden">
                      ...
                      <div className="px-4 py-3 border-b border-[#E7E1D7] dark:border-[#2E2824]">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase bg-purple-50 dark:bg-purple-950/50 text-purple-700 dark:text-purple-300 border border-purple-200 dark:border-purple-900">
                            {user.role}
                          </span>
                        </div>
                        {user.id && (
